...
<html>
	...
	<div class="courses-view">
		...
		<div class="eighty">
		<?php 
			$select_query = "SELECT * FROM scholarship WHERE category ='".$_GET['category']."' AND class ='".$_GET['class']."'";
			$select_query_result = mysqli_query($con, $select_query) or die(mysqli_error($con));
			echo '<span class="title"><CENTER>Scholarships Suitable for you are..</CENTER></span><br>';

			while ($row = mysqli_fetch_array($select_query_result)){
				if (!empty($row)) {
					echo '<span style="color: white;"><b>'.$row['name'].'</b></span><br>';
			echo $row['category'].'<br>';
			echo $row['class'].'<br><br><hr>';
				} else {
					echo "Nothing..";
				}
