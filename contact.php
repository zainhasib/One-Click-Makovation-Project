...
<html>
	...
	<title>Contact &mdash; OneClick</title>
				...
				<div class="col-md-12 col-md-offset-0 text-center">
					...
					<div class="row row-mt-15em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
							...
							<h1 class="cursive-font">Hello Fellas!</h1>	
						</div>
			...
			<div class="row">
					...
					<form action="connect.php" method="GET">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea name="message" name="message" id="message" cols="30" rows="10" class="form-control" placeholder="Write us something"></textarea>
							</div>
						</div>
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="gtco-contact-info">
						...
						<ul>
							<li class="address">KIIT, Patia <br> Bhubaneswar - 751024</li>
							<li class="phone"><a href="tel://1234567920">+91 9521873068</a></li>
							<li class="email"><a href="mailto:info@yoursite.com">oneclick@gmail.com</a></li>
							<li class="url"><a href="http://FreeHTML5.co">OneClick.com</a></li>
						</ul>
					</div>
